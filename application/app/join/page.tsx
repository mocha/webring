        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="flex items-center gap-2 p-6 mt-6 mb-6 bg-blue-50 border border-blue-200 rounded-lg text-blue-800">
              ...
              <p className="text-sm">
                <strong>Alternately:</strong> if you're comfortable jamming out your own code, you can nab the data from <a href="/data/full-ring.json" target="_blank" rel="noopener noreferrer"><code className="bg-blue-100 px-1 py-0.5 rounded">/data/full-ring.json</code></a> (or swap the filename for a ringlet) and make your own navigation thingy! 
              </p>
            </div>
